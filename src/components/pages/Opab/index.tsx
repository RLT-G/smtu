        ...
        <>
            ...
            <div className={clases.Wrapper}>
                ...
                <div className={clases.InnerWrapper}>
                    ...
                    <ArticleText className={clases.Section} text={"В июле 1941 года был сформирован 264-й отдельный пулемётно-артиллерийский батальон, состоящий примерно из 1100 ополченцев-добровольцев. В батальон было отобрано примерно 450 студентов и сотрудников Ленинградского кораблестроительного института, около 650 добровольцев с завода им. Андре Марти (нынешние «Адмиралтейские верфи») и завода по обработке цветных металлов им. К.Е. Ворошилова."}/>
                    ...
                    <br/><br/>
                    <ArticleText className={clases.Section} text={"Вся история 264-го ОПАБ от набора добовровольцев в ополчение и до его расформирования после потери 95% личного состава умещается в три месяца.  Наши сотрудники по крупицам собрали информацию из различных источников и смогли восстановить полную хронологию событий 264-го батальона. "}/>
                    ...
                    <OpabCarusel className={clases.Section}>
                    ...
                    <ArticleText className={clases.Section} text={"«Хронология 264-го ОПАБа. Подвиг Героев судостроителей» — это видеопроект, созданный студентами СПбГМТУ в память о подвиге студентов и сотрудников Ленинградского кораблестроительного института."}/>
